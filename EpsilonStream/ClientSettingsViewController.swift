...
class ClientSettingsViewController: UIViewController {
    ...
    @IBAction func aboutAction(_ sender: Any) {
        jumpToWebPage(withURLstring: "http://www.epsilonstream.com/")
    ...
    @IBAction func shareAppAction(_ sender: Any) {
        print("share app")
        let shareString = "I am using Epsilon Stream. Get it from http://www.epsilonstream.com ."
    ...
    @IBAction func registerAction(_ sender: Any) {
        jumpToWebPage(withURLstring: "http://www.oneonepsilon.com/register")
    }
    ...
    @IBAction func feedbackAction(_ sender: Any) {
        jumpToWebPage(withURLstring: "http://www.oneonepsilon.com/contact")
    }
    override func viewDidLoad() {
        super.viewDidLoad()

        _ = WebViewPrefetcher.doWebPage(withURLString: "http://www.epsilonstream.com/")
        //view.addSubview(vw1!)
        _ = WebViewPrefetcher.doWebPage(withURLString: "http://www.oneonepsilon.com/register")
        //view.addSubview(vw2!)
        _ = WebViewPrefetcher.doWebPage(withURLString: "http://www.oneonepsilon.com/contact")
        //view.addSubview(vw3!)
